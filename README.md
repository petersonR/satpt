...
The default `threshold = 0.05 / qnorm(0.975)` (about `0.0255`) is the
standard error that yields a 95% confidence interval half-width of
exactly 0.05 — i.e. ±5 percentage points around each proportion. Tighten
it (e.g. `threshold = 0.01`) when you need finer precision; loosen it
